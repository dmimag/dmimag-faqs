...
class Dmimag_Faqs_Post_Types {
  ...
  private function register_single_post_type( $fields ) {
    ...
    $labels = array(
      ...
      'new_item'              => sprintf( __( 'New %s', 'dmimag-faqs' ), $fields['singular'] ),
      'add_new_item'          => sprintf( __( 'Add new %s', 'dmimag-faqs' ), $fields['singular'] ),
      'edit_item'             => sprintf( __( 'Edit %s', 'dmimag-faqs' ), $fields['singular'] ),
      'view_item'             => sprintf( __( 'View %s', 'dmimag-faqs' ), $fields['singular'] ),
      'view_items'            => sprintf( __( 'View %s', 'dmimag-faqs' ), $fields['plural'] ),
      'search_items'          => sprintf( __( 'Search %s', 'dmimag-faqs' ), $fields['plural'] ),
      'not_found'             => sprintf( __( 'No %s found', 'dmimag-faqs' ), strtolower( $fields['plural'] ) ),
      'not_found_in_trash'    => sprintf( __( 'No %s found in trash', 'dmimag-faqs' ), strtolower( $fields['plural'] ) ),
      'all_items'             => sprintf( __( 'All %s', 'dmimag-faqs' ), $fields['plural'] ),
      'archives'              => sprintf( __( '%s Archives', 'dmimag-faqs' ), $fields['singular'] ),
      'attributes'            => sprintf( __( '%s Attributes', 'dmimag-faqs' ), $fields['singular'] ),
      'insert_into_item'      => sprintf( __( 'Insert into %s', 'dmimag-faqs' ), strtolower( $fields['singular'] ) ),
      'uploaded_to_this_item' => sprintf( __( 'Uploaded to this %s', 'dmimag-faqs' ), strtolower( $fields['singular'] ) ),

      /* Labels for hierarchical post types only. */
      'parent_item'           => sprintf( __( 'Parent %s', 'dmimag-faqs' ), $fields['singular'] ),
      'parent_item_colon'     => sprintf( __( 'Parent %s:', 'dmimag-faqs' ), $fields['singular'] ),
  ...
  private function register_single_post_type_taxnonomy( $tax_fields ) {
    ...
    $labels = array(
      ...
      'all_items'                  => sprintf( __( 'All %s', 'dmimag-faqs' ), $tax_fields['plural'] ),
      'edit_item'                  => sprintf( __( 'Edit %s', 'dmimag-faqs' ), $tax_fields['single'] ),
      'view_item'                  => sprintf( __( 'View %s', 'dmimag-faqs' ), $tax_fields['single'] ),
      'update_item'                => sprintf( __( 'Update %s', 'dmimag-faqs' ), $tax_fields['single'] ),
      'add_new_item'               => sprintf( __( 'Add New %s', 'dmimag-faqs' ), $tax_fields['single'] ),
      'new_item_name'              => sprintf( __( 'New %s Name', 'dmimag-faqs' ), $tax_fields['single'] ),
      'parent_item'                => sprintf( __( 'Parent %s', 'dmimag-faqs' ), $tax_fields['single'] ),
      'parent_item_colon'          => sprintf( __( 'Parent %s:', 'dmimag-faqs' ), $tax_fields['single'] ),
      'search_items'               => sprintf( __( 'Search %s', 'dmimag-faqs' ), $tax_fields['plural'] ),
      'popular_items'              => sprintf( __( 'Popular %s', 'dmimag-faqs' ), $tax_fields['plural'] ),
      'separate_items_with_commas' => sprintf( __( 'Separate %s with commas', 'dmimag-faqs' ), $tax_fields['plural'] ),
      'add_or_remove_items'        => sprintf( __( 'Add or remove %s', 'dmimag-faqs' ), $tax_fields['plural'] ),
      'choose_from_most_used'      => sprintf( __( 'Choose from the most used %s', 'dmimag-faqs' ), $tax_fields['plural'] ),
      'not_found'                  => sprintf( __( 'No %s found', 'dmimag-faqs' ), $tax_fields['plural'] ),
    );
  ...
  public function create_custom_post_type() {
    ...
    $post_types_fields = array(
      array(
        'slug'                  => $this->post_type,
        'singular'              => __( 'FAQ', 'dmimag-faqs' ),
        'plural'                => __( 'FAQs', 'dmimag-faqs' ),
        'menu_name'             => __( 'FAQs', 'dmimag-faqs' ),
        'description'           => __( 'FAQs', 'dmimag-faqs' ),
        'has_archive'           => false,
        'hierarchical'          => false,
